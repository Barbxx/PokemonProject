...
public class DatosBasePokemon {
        ...
        public DatosBasePokemon(String nombre, String descripcion,
        ...
        private static final Map<String, DatosBasePokemon> DATABASE = new TreeMap<>();
        ...
        static {
                ...
                DATABASE.put("Pichu", new DatosBasePokemon(
                                "Pichu",
                ...
                DATABASE.put("Mime Jr.", new DatosBasePokemon(
                                "Mime Jr.",
                ...
                DATABASE.put("Chimchar", new DatosBasePokemon(
                                "Chimchar",
                ...
                DATABASE.put("Gastly", new DatosBasePokemon(
                                "Gastly",
                ...
                DATABASE.put("Goomy", new DatosBasePokemon(
                                "Goomy",
                ...
                DATABASE.put("Togepi", new DatosBasePokemon(
                                "Togepi",
                ...
                DATABASE.put("Turtwig", new DatosBasePokemon(
                                "Turtwig",
                ...
                DATABASE.put("Growlithe H.", new DatosBasePokemon(
                                "Growlithe H.",
                ...
                DATABASE.put("Qwilfish H.", new DatosBasePokemon(
                                "Qwilfish H.",
                ...
                DATABASE.put("Piplup", new DatosBasePokemon(
                                "Piplup",
                ...
                DATABASE.put("Basculin Red-Striped", new DatosBasePokemon(
                ...
                DATABASE.put("Sneasel H.", new DatosBasePokemon(
                                "Sneasel H.",
                ...
                DATABASE.put("Gible", new DatosBasePokemon(
                                "Gible",
                ...
                DATABASE.put("Voltorb H.", new DatosBasePokemon(
                                "Voltorb H.",
                ...
                DATABASE.put("Cleffa", new DatosBasePokemon(
                                "Cleffa",
                ...
                DATABASE.put("Cyndaquil", new DatosBasePokemon("Cyndaquil",
                ...
                DATABASE.put("Oshawott", new DatosBasePokemon("Oshawott",
                ...
                DATABASE.put("Arceus", new DatosBasePokemon("Arceus",
        ...
        public static DatosBasePokemon get(String nombre) {
