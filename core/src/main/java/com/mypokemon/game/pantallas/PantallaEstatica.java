 ...
 */
public abstract class PantallaEstatica extends PantallaBase implements INavegable {
    ...
    public PantallaEstatica(PokemonPrincipal game, Screen returnScreen, String backgroundPath) {
        super(game);
