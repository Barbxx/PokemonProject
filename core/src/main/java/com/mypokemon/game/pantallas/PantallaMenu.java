...
import com.mypokemon.game.utils.IGestorEntrada;
 ...
 */
public abstract class PantallaMenu extends PantallaBase implements IGestorEntrada {
    ...
    public PantallaMenu(PokemonPrincipal game) {
        super(game);
    }
