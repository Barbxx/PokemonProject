...
import com.mypokemon.game.utils.IGestorTexturas;
 ...
 * helper methods.
 */
public abstract class PantallaBase implements Screen, IGestorTexturas {

    protected final PokemonPrincipal game;
    private final List<Texture> textures;

    public PantallaBase(PokemonPrincipal game) {
        this.game = game;
