...
public class PantallaCrafteo extends PantallaBase {

    private Texture background;
    private PantallaJuego returnScreen;
    ...
    public PantallaCrafteo(PokemonPrincipal game, PantallaJuego returnScreen) {
        super(game);
    ...
    private void loadAssets() {
        try {
            ...
            try {
                ...
                Gdx.app.error("Crafteo", "Error loading Objeto textures", e);
            }
            ...
            Gdx.app.error("PantallaCrafteo", "Asset Error: " + e.getMessage());
        }
    }
    ...
    // Helper to extract description using ObjectFactory
    private String getDescriptionForId(String id) {
        return ObjectFactory.crearCrafteado(id, 1).getDescripcion();
    }
