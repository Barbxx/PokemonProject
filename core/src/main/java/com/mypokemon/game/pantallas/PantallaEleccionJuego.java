...
public class PantallaEleccionJuego extends PantallaBase {
    ...
    public PantallaEleccionJuego(PokemonPrincipal game) {
        super(game);
    ...
    private void startSoloGame() {
        ...
        game.setScreen(new PantallaIntro(game, inputName));
        dispose();
    }

    private void startCompartidaGame() {
        // No input validation needed as we don't ask for generic password/name anymore
        // Pass a generic temporary ID, the real name is asked in PantallaIntro
        game.setScreen(new PantallaCompartida(game, "Explorador"));
        dispose();
    }
