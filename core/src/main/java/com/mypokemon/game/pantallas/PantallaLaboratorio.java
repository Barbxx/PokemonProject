...
public class PantallaLaboratorio extends PantallaBase {
    ...
    private final String[] INTRO_TEXT = {
            ...
            "Vea, hay que ver que tipo de Pokémon le gusta...agarrese uno"
    };
    ...
    // Success Texts
    private final String[] ROWLET_SUCCESS = { "¡Recibiste el Pokémon Rowlet de manos del Profesor Ferxxo!" };
    private final String[] CYNDAQUIL_SUCCESS = { "¡Recibiste el Pokémon Cyndaquil de manos del Profesor Ferxxo!" };
    private final String[] OSHAWOTT_SUCCESS = { "¡Recibiste el Pokémon Oshawott de manos del Profesor Ferxxo!" };
    ...
    public PantallaLaboratorio(PokemonPrincipal game, PantallaJuego PantallaJuego) {
        super(game);
    ...
    public void show() {
        try {
            ...
            if (PantallaJuego.getPlayerSheet() != null) {
                TextureRegion[][] frames = TextureRegion.split(PantallaJuego.getPlayerSheet(),
                        PantallaJuego.getPlayerSheet().getWidth() / PantallaJuego.getFrameCols(),
                        PantallaJuego.getPlayerSheet().getHeight() / PantallaJuego.getFrameRows());
            ...
            Gdx.app.log("PantallaLaboratorio", "Error loading textures: " + e.getMessage(), e);
        }
    }
        ...
        if (showDialog && !fadingOut) {
                ...
                if (Gdx.input.isKeyJustPressed(Input.Keys.ENTER)) {
                    if (selectionIndex == 0) {
                        ...
                        if (!selectedName.isEmpty()) {
                            Explorador exp = PantallaJuego.getExplorador();
            ...
            if (Gdx.input.justTouched()) {
                ...
                // Check Rowlet click
                    ...
                    // Tocar grito de Rowlet
                    new Pokemon("Rowlet", 0, 0, false, "").tocarGrito();
                }
                // Check Cyndaquil click
                    ...
                    // Tocar grito de Cyndaquil
                    new Pokemon("Cyndaquil", 0, 0, false, "").tocarGrito();
                }
                // Check Oshawott click
                    ...
                    // Tocar grito de Oshawott
                    new Pokemon("Oshawott", 0, 0, false, "").tocarGrito();
                }
            }
    ...
    private void drawDialog() {
        ...
        if (selectionActive) {
            ...
            if (selectionIndex == 0)
                ...
                game.font.setColor(Color.BLACK);
            game.font.draw(game.batch, "> SI", optionX, optionY);
