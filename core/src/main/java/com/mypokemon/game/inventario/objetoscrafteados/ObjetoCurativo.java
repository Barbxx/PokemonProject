...
/**
 * Clase abstracta base para ƒÂ­tems que curan HP.
 */
public abstract class ObjetoCurativo extends ObjetoConsumible {
    protected final float cantidadCuracion;

    public ObjetoCurativo(String id, String nombre, String descripcion, int cantidad, float cantidadCuracion) {
