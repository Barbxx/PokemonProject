...
/**
 * Handles all UI rendering for the PantallaJuego.
...
public class UIJuego {
    ...
    public UIJuego() {
        ...
        this.uiWhitePixel = UtilidadesTextura.createSolidTexture(1, 1, Color.WHITE);
        try {
    ...
    public void renderNotification(SpriteBatch batch, String message) {
        if (message != null && !message.isEmpty()) {
            font.setColor(new Color(0.7f, 0.3f, 1f, 1f)); // Morado vibrante
