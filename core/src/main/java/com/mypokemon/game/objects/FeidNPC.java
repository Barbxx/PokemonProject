...
public class FeidNPC extends NPC {
    private static final String[] DIALOG = {
            ...
            "Vea pues, le cuento, OneFerxxo está dividido en cinco zonas que están una chimba, pero la vuelta está caliente, ¿sabía? Usted no puede andar por ahí normal, sin con qué defenderse...",
            ...
            "Ese que nos mandó a toditos para acá... ¡y yo que estaba relajado comiéndome un chicharrón! Imagínese esa vuelta...",
