 ...
 * @author damios
 */
public class AyudanteInicio {

    private static final String JVM_RESTARTED_ARG = "jvmIsRestarted";

    private AyudanteInicio() {
     ...
     * 	if (AyudanteInicio.startNewJvmIfRequired(true)) return; // This handles macOS support and helps on Windows.
...
// We revert our changes immediately after loading LWJGL3 natives.
     ...
     * <pre>
     * public static void main(String... args) {
     * 	if (AyudanteInicio.startNewJvmIfRequired()) return; // This handles macOS support and helps on Windows.
